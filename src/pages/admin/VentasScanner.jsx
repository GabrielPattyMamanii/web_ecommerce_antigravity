            ...
            {cart.length > 0 && (
                <div className="bg-card border border-border rounded-2xl overflow-hidden">
                    ...
                    <div ref={cartFooterRef} className="p-4 border-t border-border space-y-2 scroll-mb-4">
                        ...
                        {/* Nombre opcional del pedido */}
                        <div className="rounded-xl border-2 p-3 space-y-1.5" style={{ borderColor: '#f59e0b40', backgroundColor: '#f59e0b0d' }}>
                            <label htmlFor="nombre-pedido" className="text-xs font-semibold text-foreground/80 flex items-center gap-1.5">
                                <span className="flex items-center justify-center w-5 h-5 rounded-md text-amber-600 dark:text-amber-400" style={{ backgroundColor: '#f59e0b20' }}>
                                    <Tag className="w-3 h-3" />
                                </span>
                                Nombre del pedido
                                <span className="text-[10px] font-semibold text-amber-700 dark:text-amber-300 px-1.5 py-0.5 rounded-full" style={{ backgroundColor: '#f59e0b30' }}>opcional</span>
                            </label>
                            <input
                                id="nombre-pedido"
                                type="text"
                                ...
                                placeholder={`Pedido de las ${new Date().toLocaleTimeString('es-AR', { hour: '2-digit', minute: '2-digit' })}`}
                                maxLength={80}
                                ...
                                onFocus={(e) => { e.target.style.borderColor = '#f59e0b'; e.target.style.boxShadow = '0 0 0 4px #f59e0b1a'; }}
                                onBlur={(e) => { e.target.style.borderColor = '#f59e0b50'; e.target.style.boxShadow = 'none'; }}
                            />
                        </div>
