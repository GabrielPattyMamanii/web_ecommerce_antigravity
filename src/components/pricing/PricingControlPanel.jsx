...
export function PricingControlPanel({
    ...
    return (
        <div className="sticky top-0 z-50 bg-card/95 backdrop-blur shadow-sm border-b border-border p-4 mb-6">
                    ...
                    <div className="bg-card p-3 rounded-lg border border-border shadow-sm">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="pl-7 font-mono font-bold text-primary bg-background border-input"
                            />
                        </div>
                    </div>
                    ...
                    <div className="bg-card p-3 rounded-lg border border-border shadow-sm">
                        ...
                        <div className="flex gap-2">
                            <select
                                ...
                                className="h-10 rounded-md border border-input bg-background text-foreground px-3 py-2 text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                            >
                            ...
                            {localIndiceTipo === 'personalizado' && (
                                <Input
                                    ...
                                    className="w-24 text-center bg-background border-input text-foreground"
                                />
                            )}
                        </div>
                    </div>
