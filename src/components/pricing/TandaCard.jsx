...
import { Calendar, Package, Layers, ShoppingBag, Archive } from 'lucide-react';
            ...
            <CardContent className="p-6">
                ...
                <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                        <div className={`p-3 rounded-xl ${tanda.isOldEntrada ? 'bg-amber-500/10' : 'bg-primary/10'}`}>
                            {tanda.isOldEntrada
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                {tanda.isOldEntrada && (
                                    <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-amber-500/15 text-amber-600 dark:text-amber-400 border border-amber-500/25">
                                        Archivo
                                    </span>
                                )}
                            </div>
