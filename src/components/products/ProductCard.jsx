    ...
    return (
        <Link to={getProductUrl(product.id)} className="group block">
            <div className="space-y-3">
                {/* Image Container */}
                <div className="relative aspect-[1/1.1] bg-gray-100 rounded-[20px] overflow-hidden border-2 border-transparent group-hover:border-public-secondary transition-all">
                    <img
                    ...
                    />
                    {hasDiscount && (
                        <div className="absolute top-3 left-3 bg-public-tertiary text-public-primary text-xs font-bold px-3 py-1 rounded-full">
                ...
                {/* Product Info */}
                <div>
                    <h3 className="font-bold text-sm md:text-lg text-black truncate uppercase font-chango">
                        {product.name}
                    </h3>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                        <span className="text-lg md:text-xl font-bold text-public-primary">
                            ${currentPrice}
                        </span>
