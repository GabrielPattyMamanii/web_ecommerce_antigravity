...
export function ProductTable({ products, dollarRate, totalExpenses }) {
    ...
    const expenseValue = parseFloat(totalExpenses) || 0;
            ...
            <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y divide-border bg-card">
                    {products.map((product, idx) => {
                        ...
                        const totalWithExpense = convertedTotal + expenseValue;
